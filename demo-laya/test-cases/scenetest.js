export function sceneTest(canvas, canvas2d, canvasChar) {
  ...
  testUI.uiView = {
    type: 'Scene',
    props: { width: 720, height: 1280 },
    compId: 2,
    child: [
      {
        type: 'Image',
        props: { y: 169, x: 104, skin: 'comp/image.png' },
        compId: 3,
      },
      {
        type: 'Button',
      ...
      },
      {
        ...
        props: {
          y: 727,
          x: 402,
          points: '-10,20,106,-37,152,32,2,80',
          lineWidth: 1,
          lineColor: '#ff0000',
          fillColor: '#00ffff',
        },
    ...
    loadList: ['comp/image.png', 'comp/button.png'],
    loadList3D: [],
  }
  ...
  class Test extends testUI {
    ...
    onClick() {
      ...
      skeleton.load(
        'https://a0.seayooassets.com/web/zero/spine/test-boy/spineboy.json',
  ...
  class TestScene {
    ...
    run() {
      Laya.loader.load(
        'https://a0.seayooassets.com/web/zero/spine/test-boy/spineboy.atlas',
